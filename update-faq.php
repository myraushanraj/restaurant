...
<p style="margin-top:50px;color:grey;text-align: center" id="para1">You are advised to enter the title section first and then the sub-section for it. </p>
<form id="uploader_form" class="form_content">
<?php 
