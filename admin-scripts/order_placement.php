...
$order_status=$obj->add_new_order($bill,$customername,$email,$center,$timings,$phone,$timenow,$address);

if($order_status){ ?>
<script>
window.location='../make-payment.php?orderid=<?php echo $order_status;?>';
</script>
	<?php }else{ ?>
