        ...
        <?php } ?>
          ...
          <table style="width: 70%;margin:">
            <tbody>
              ...
              <tr><td>Delivery Person</td><td>gdf<?php $order->delivery_boy;?></td></tr>
            </tbody>
          </table>
          </div>
...
<form action='#' method='post' >
  ...
  <h4 class="modal-title">Track My Orderr</h4>
...
<a href='javascript:void(0)' id="bookingidtrackbtn" class='modal-btn'  onclick='track_my_booking()' name='update_booking'>Track</a><br>
</form>
