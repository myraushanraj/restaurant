...
function restaurant_menu(){
            	$d1=new dbconn();$arr1=array();
	               	$db=$d1->connect();
        			 $cmd="select sl from bawarchi where status='1'";
				     $result=$db->query($cmd);
...
function restaurant_menu_sorted($cat){
            	$d1=new dbconn();$arr1=array();
	               	$db=$d1->connect();
        			 $cmd="select sl from bawarchi where cat_name='$cat' and status='1'";
				     $result=$db->query($cmd);
                                   while($row=$result->fetch()){ 
				                   	       array_push($arr1,$row);
				                                               }
...
$d1=new dbconn();$arr1=array();
	               	$db=$d1->connect();
        			 $cmd="UPDATE bawarchi set click_count=click_count+1 where sl='$id'";
				     $result=$db->query($cmd);	
}
class products{
