...
function check_or_add_user($name,$phone,$email){
$customer=new customer($email);print_r($customer);
if(empty($customer->name))
{
	...
	// step 1:  increment thw wishlist  followers count 
        						 $sql="INSERT INTO customer(name,email,phone,registration_time)  VALUES ('$name','$email','$phone','$registration_time')";
                                         $qry = $con->query($sql);
 }else
 return 0;                               
