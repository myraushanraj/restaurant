         ...
         if($order->food_status!='delivered')
          ...
          <table>
            <tbody>
              ...
              <tr><td>Order Status</td><td><?php echo $order->food_status?></td></tr>
              <tr><td>Order Amount</td><td><?php echo $order->bill?></td></tr>
              <tr><td>Payment Type</td><td><?php echo 'Online Paid '?></td></tr>
              <tr><td>Delivery Person</td><td> <?php echo $order->delivery_boy_name; ?></td></tr>
              <tr><td>Delivery Contact</td><td> <?php echo $order->delivery_boy_phone; ?></td></tr>
