...
<a href="saved-order.php" style="padding-top:4px"> &nbsp;&nbsp; <img src="http://www.eatnary.com/icon/<?php echo $setup->icon_cart_link?>" class="cart_icon" style="width:32px;">&#8377; <?php echo $bill1?> checkout</a>
