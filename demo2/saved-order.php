...
<div class="col-md-6">
	...
	<div class="cart_detail">
			...
			<?php
			 for($r=0;$r<sizeof($master_arr)-1;$r++)
				...
				<tr>
					...
					<td><a class="incr-btn" data-action="decrease" href="javascript:void(0)" onclick="change_qty('<?php echo $r;?>','desc');modify_cart_item('<?php echo $cart_product->productid?>','<?php echo $r;?>')">
					...
					<td>
					  <a class="incr-btn" data-action="increase" href="javascript:void(0)"  onclick="change_qty('<?php echo $r;?>','asc');modify_cart_item('<?php echo $cart_product->productid?>','<?php echo $r;?>')">
		...
		<table style="width: 100%">
			<tbody>
			<tr>
					<td colspan="5" class="theme1" href="javascript:void(0)" onclick="check_minimum_order()"><a href="javascript:void(0)" onclick="check_minimum_order()">Checkout</a></td>
		...
		<table style="width: 100%">
			<tbody>
			<tr>
					<td colspan="5" style="text-align: center" id="error_checkout">OR</td>
				</tr>
...
//alert('resto open  time is'+opening_time);
	...
	//check closing time 
		...
		error="oop's our restaurants has been close by just minute ago";
	}
	//check opening time
