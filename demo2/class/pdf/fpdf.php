...
$address=$setup->company.' : '.$setup->support_address;
...
$this->Cell(0,2,"-------------------------------------------------------------------------------------------------------------------------------","0","1",C);
		$this->Ln(2.8);
	    $this->SetX(22);
	$this->Cell(0,2,"All Right Reserved | Email: {$setup->support_email} | call us {$setup->support_phone}","0","1",C);
		$this->Ln(2.8);
			$this->SetFont("Arial","B",8);
			$this->Cell(0,2,"{$address}","0","1",C);
					$this->Ln(2.8);
}
