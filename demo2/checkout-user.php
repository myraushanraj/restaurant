<?php require_once('inc/header1.php');require_once "class/order_class.php";?>
<style type="text/css">
			#scooter{
...
<div class="col-md-12">
	<div class="congra theme2">
		...
		<div class="cogra2">
		<p style="text-align: center;">SMS Acknowledgement has been send to your mobile : <?php echo $order->phone?> </p>
		<p style="text-align: center;">Invoice for this order with track link has been attached to your mail Id: <?php echo $order->email?></p>
	</div>
	</div>
...
setInterval(track_delivery_auto_call,1200);
